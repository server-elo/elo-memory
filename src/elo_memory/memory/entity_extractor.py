...
_SKIP_WORDS: frozenset[str] = frozenset({
    ...
    "We", "You", "They", "He", "She",
    "If", "But", "And", "Or", "So", "As", "At", "By", "In", "On", "To",
    "For", "From", "With", "About", "After", "Before", "Between",
    # Action verbs / gerunds that start with a capital letter
    "Using", "Keeping", "Making", "Getting", "Going", "Having",
    "Running", "Building", "Creating", "Starting", "Setting",
    "Adding", "Updating", "Moving", "Looking", "Working",
    "Thinking", "Trying", "Finding", "Taking", "Coming",
    "Calling", "Pulling", "Pushing", "Fixing", "Testing",
    "Writing", "Reading", "Sending", "Deploying", "Launching",
    "Here", "Now", "Then", "Also", "Just", "Very",
    "Each", "Every", "Some", "Any", "All", "Both", "Most",
    "Can", "Could", "Should", "Would", "Will", "May", "Might",
    "Do", "Does", "Did", "Has", "Have", "Had",
    "Is", "Are", "Was", "Were", "Be", "Been", "Being",
    "Not", "No", "Yes",
    "Let", "See", "Try", "Use", "Need", "Want", "Like",
    "Got", "Get", "Set", "Put", "Run", "Ran",
    "However", "Therefore", "Furthermore", "Moreover",
    "Since", "Until", "While", "During", "Because",
    "Still", "Already", "Maybe", "Perhaps",
...
_ROLE_WORDS: frozenset[str] = frozenset({
    "engineer", "manager", "director", "ceo", "cto", "cfo", "coo",
    "vp", "president", "lead", "senior", "junior", "intern",
    "doctor", "dr", "professor", "prof",
    "wife", "husband", "daughter", "son", "brother", "sister",
    "friend", "colleague", "coworker", "boss", "mentor", "mentee",
    "hired", "promoted", "fired", "met", "called", "emailed",
    "architect", "designer", "developer", "analyst", "consultant",
    "nurse", "therapist", "coach", "teacher", "tutor",
    "captain", "lieutenant", "sergeant",
    "uncle", "aunt", "cousin", "nephew", "niece",
    "partner", "fiancee", "fiance",
    "mr", "mrs", "ms", "miss",
})
...
_NOT_NAMES: frozenset[str] = frozenset({
    # Tech products
    "Prisma", "Redis", "Vercel", "Docker", "Firebase", "React",
    "Angular", "Vue", "Svelte", "Django", "Flask", "Rails",
    "Postgres", "Mongo", "MySQL", "SQLite", "Kafka", "Nginx",
    "Jenkins", "Travis", "Heroku", "Netlify", "Gatsby", "Hugo",
    "Webpack", "Babel", "Eslint", "Prettier", "Tailwind",
    "Bootstrap", "Express", "Fastify", "Deno", "Remix",
    "Kubernetes", "Terraform", "Ansible", "Vagrant",
    "Elasticsearch", "Grafana", "Prometheus", "Datadog",
    "Stripe", "Twilio", "Sentry", "Supabase", "Hasura",
    "Apollo", "GraphQL", "TypeScript", "JavaScript", "Python",
    "Golang", "Kotlin", "Swift", "Rust",
    "Chrome", "Firefox", "Safari", "Opera", "Edge",
    "Ubuntu", "Debian", "Alpine", "CentOS", "Fedora",
    "GitHub", "GitLab", "Bitbucket", "Jira", "Slack",
    "Notion", "Figma", "Postman", "Insomnia",
    "Node", "Bun", "Yarn", "Pnpm",
    "Azure", "Lambda", "Cloudflare", "Akamai",
    "Cypress", "Playwright", "Selenium", "Mocha", "Jest",
    # Place-name components (these appear as first word of multi-word places)
    "San", "Los", "Las", "New", "North", "South", "East", "West",
    "Saint", "Fort", "Mount", "Lake", "Port", "Cape",
    "El", "La", "De", "Del",
})
...
_VERSION_RE = re.compile(
    r"\b(?:v|version\s*)\d+(?:\.\d+)*\b", re.IGNORECASE
)
...
_NAME_ROLE_RE = re.compile(
    r"\b(" + "|".join(re.escape(w) for w in sorted(_ROLE_WORDS)) + r")"
    r"\s+([A-Z][a-z]{1,})\b",
    re.IGNORECASE,
)
